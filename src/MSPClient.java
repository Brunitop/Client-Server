    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (!command.contains("CONNECT ")) {
                if (command.equals("DISCONNECT") || command.equals("LIST") || command.contains("SEND #")) {
                    System.out.println("Usted no está conectado al servidor");
                } else {
                ...
                username = namelist.toString();

                //checa si el nombre de usuario ya está en uso
                if(MSPServer.nameTaken(username)){
                    System.out.println("Ese nombre ya esta en uso. Intente otro.");
                }
                else {
                    ...
                    while(!command.equals("DISCONNECT")){
                        ...
                        if(command.length() > 6){
                            ...
                            sendcheck = Arrays.toString(send);
                        }
